...
class BattlesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create battle" do
    assert_difference('Battle.count') do
      post battles_url, params: { battle: { battle_sprint_id: @battle.battle_sprint_id, clan_user_id: @battle.clan_user_id, damage: @battle.damage, number: @battle.number } }
    end
  ...
  test "should update battle" do
    patch battle_url(@battle), params: { battle: { battle_sprint_id: @battle.battle_sprint_id, clan_user_id: @battle.clan_user_id, damage: @battle.damage, number: @battle.number } }
